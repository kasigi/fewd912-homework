...
const bigAnimals = ["horse","buffalo","giant ground sloth","elephant", "giraffe", "grizzly", "rhino", "bison", "panda", "komodo dragon"];
...
while (myCard !== "A") {
  let pickACardIndex = Math.floor(Math.random() * myDeck.length);
  console.log("CardIndex: " + pickACardIndex);

  myCard = myDeck[pickACardIndex]; // selects random index from array.
  console.log("My Card is: " + myCard);
